# 👋 Hi, I'm Oriac Gimeno Lozano (Oriac Gimeno)

### Business Development Director | B2B Commercial Strategy · Data-Driven Growth
**Bridging the gap between high-level business strategy and data-driven execution.**
...
### 🌱 Current Focus
*   Applying data analytics to international business strategy.
*   Sales forecasting and performance analysis.
*   Market entry and commercial optimization.
*   Building structured data workflows (ETL concepts, cloud fundamentals).
...
*   **Web Scraping & APIs**
*   **Power BI** | **Excel (Advanced)** | **Statistics**
...
**Business & Leadership**
*   Export Area Management | Key Account Management (KAM)
*   International Business Development | Market Entry Strategy
*   Strategic Marketing & Sales | Digital Transformation
*   International Negotiation | Full P&L & Budget Management (up to €8M)
*   Cross-functional team leadership

### 🧭 Career Journey
From **global export leadership** to **data-driven business strategy**. My professional evolution reflects a shift from managing international results to designing analytical systems and processes that **predict, optimize and support business decisions**. Every technical tool I use is grounded in a **real commercial objective**.

---

## 🇪🇸 Perfil en Castellano
...
### 🌱 Enfoque actual
*   Aplicación de analítica de datos a la estrategia internacional.
*   Previsión de ventas y análisis de rendimiento.
*   Optimización comercial y entrada en mercados.
*   Construcción de flujos de datos estructurados (conceptos ETL y fundamentos de cloud).

### 🛠️ Habilidades y competencias
*   **Datos y Tecnología:** Python (Pandas, NumPy, Scikit-learn), SQL (PostgreSQL, MySQL), Web Scraping & APIs, Power BI, Excel (Avanzado), Estadística.
*   **Métodos & Workflow:** Toma de decisiones basada en datos, Conceptos ETL / pipelines de datos, Fundamentos de Cloud (AWS / GCP), Git & GitHub, Agile / Scrum / Kanban.
*   **Negocio y Liderazgo:** Export Area Management, Key Account Management (KAM), Desarrollo de negocio internacional, Estrategia de entrada en mercados, Marketing estratégico y ventas, Transformación digital, Negociación internacional, Gestión completa de P&L y presupuestos (hasta €8M), Liderazgo de equipos cross-functional.

### 🧭 Trayectoria profesional
De **liderazgo global en exportación** a **estrategia empresarial basada en datos**. Mi evolución profesional refleja el paso de gestionar resultados internacionales a diseñar sistemas y procesos analíticos que predicen, optimizan y respaldan la toma de decisiones. Cada herramienta técnica que utilizo está siempre vinculada a una **necesidad comercial real**.
